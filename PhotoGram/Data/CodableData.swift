...
struct CoverPhoto: Codable {
    let id, slug: String
    let createdAt, upStringdAt: String?
    let promotedAt: String?
    let width, height: Int
    let color, blurHash: String
    let description: String?
...
struct CoverPhotoTopicSubmissions: Codable {
    let texturesPatterns, architectureInterior, colorOfWater, wallpapers: ArchitectureInterior?
    let nature: ArchitectureInterior?
